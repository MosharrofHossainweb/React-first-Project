        ...
        <section className="banner">
            <div className="container">
                <div className="banner_row sm:flex flex-col sm:gap-[20px]  md:flex-row-reverse gap-[72px] mt-2 lg:mt-[173px]">
                    ...
                    <div className="banner_text w-[300px] md:w-[540px] pl-[10px] ">
                        ...
                        <div className="counter_box ">
                            ...
                            <div className="counter_format flex-wrap flex gap-[15px] md:gap-[30px]">
        
                                <div className="div flex ">
        
                                <CommontCounter counterNumber={4} countComma={','} counterIcon={<FaStar />}counterText={'Rating'}/> <CommontCounter counterNumber={6}/>
                                 
                                    </div>
                                <div className="counter  flex gap-[20px] md:gap-[49px]">
